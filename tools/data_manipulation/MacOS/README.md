...
```
2. From the directory containing tiff_folder_scanner_macos.py, run:
```
pyinstaller --onefile --windowed tiff_folder_scanner_macos.py
```
...
**Note:** On macOS, you may need to allow the app to run via:
